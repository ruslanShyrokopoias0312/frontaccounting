...
echo "<body>\n";
	echo '<table class="callout_main" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td colspan="2" rowspan="2">';
		...
		echo '<table class="main_page" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td>';
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
									<tbody><tr><td>
										<div class="tabs" style="height:18.4px">
                                            ...
                                            <a class="selected" href="./funding.php">Funding</a>
			...
			echo "<Center><table class='titletext'><tr><td>Members</td></tr></table></Center>\n";
			...
			div_start('_page_body');
                ...
                <td class="tableheader">Contribution</td>
                
                <td class="tableheader">Currency</td>
                
<td class="tableheader">Contribution Type</td><td class="tableheader">Date</td>
                ...
                <tr><td class="label">Contribution</td><td><input type="text" name="phone" size="30" maxlength="30" value="$1000">
                </td>
                </tr>
                <tr><td class="label">Currency</td><td><span id="_language_sel"><select autocomplete="off" name="language" class="combo" title="" _last="0"><option selected="" value="C">AUD</option>
                ...
                <tr><td class="label">Currency Type:</td>
                <td><span id="_print_profile_sel"><select autocomplete="off" name="print_profile" class="combo" title="" _last="0"><option selected="" value="">Contribution</option>
                <option value="Central">Loans</option>
