...
echo "<body>\n";
	echo '<table class="callout_main" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td colspan="2" rowspan="2">';
		...
		echo '<table class="main_page" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td>';
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
									<tbody><tr><td>
										<div class="tabs" style="height:18.4px">
                                            ...
                                            <a class="selected" href="./expense.php">Expenses Split</a>
			...
			echo "<Center><table class='titletext'><tr><td>Expense Split</td></tr></table></Center>\n";
			echo '<div id="msgbox"></div>';
			div_start('_page_body');
				br();br();
				
				echo '<table align="center" width="80%" style="border:1px solid #cccccc;"><tbody><tr valign="top"><td width="30%"><b>Expenses:</b><br><br><a href="" style="font-weight: bold;" class="repclass_link" id="class0">-Insurance</a> <br> <a href="" style="font-weight:normal" class="repclass_link" id="class2">-Cleaning</a>      </td><td width="70%" style="border-left:1px solid #cccccc;border-right:1px solid #cccccc;padding-left:3px;">
                ...
                <td class="tableheader">Date</td>
                                ...
                                <tr><td class="label">Portion:</td><td><input type="text" name="phone" size="30" maxlength="30" value="%100">
                                </td>
                                </tr>
